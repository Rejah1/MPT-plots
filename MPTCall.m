...
%ns = linspace(25,1000,196); % makes vector of all values of T i will test
rp = linspace(0.01,2,200);
ns = round(50./rp);


for ii = 1:200
    [~, deviations(ii)] = MPTFunc(ns(ii)); % calls function for each value of t
end
